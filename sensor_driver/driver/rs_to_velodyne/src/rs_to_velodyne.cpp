...
void publish_points(T &new_pc, const sensor_msgs::msg::PointCloud2 &old_msg) {
    ...
    pc_new_msg.header.frame_id = "velodyne_base_link";
...
int main(int argc, char **argv) {
    ...
    pubRobosensePC = node->create_publisher<sensor_msgs::msg::PointCloud2>("/points", qos);
    // pubRobosensePC = node->create_publisher<sensor_msgs::msg::PointCloud2>("/points", 1);
